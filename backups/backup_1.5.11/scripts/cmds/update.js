...
module.exports = {
	...
	langs: {
		...
		en: {
			...
			updateConfirmed: "Confirmed, updating plesse wait...",
			updateComplete: "Update completed! The chatbot will restart to apply changes please wait..."
		}
	},
	...
	onLoad: async function ({ api }) {
		if (fs.existsSync(dirBootLogTemp)) {
			...
			api.sendMessage("The George Bot has been restarted.", threadID);
		}
	},
